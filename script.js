...
// Magic of chaining filter, map and reduced method together
const eurToUsd = 1.1;
...
/* const account = accounts.find(acc => acc.owner === 'Maryam Bolaji');
 console.log(account);
 */
...
const calcAverageHumanAge = function (ages) {
  ...
  // To calculate the avarage age of adults
...
// To calculate all the movements in the accounts and total
/*
...
/*
// Strings
const owners = ['Beejay', 'Ayobami', 'Maryam', 'Olawumi'];
...
const j = Array.from({ length: 100 }, (_, i) => i + 1);
// console.log(j);
